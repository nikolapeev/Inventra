    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourierCountries", x => new { x.CourierId, x.CountryId });
                    table.ForeignKey(
                        name: "FK_CourierCountries_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "CountryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourierCountries_Couriers_CourierId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourierCountries_CountryId",
                table: "CourierCountries",
                column: "CountryId");
